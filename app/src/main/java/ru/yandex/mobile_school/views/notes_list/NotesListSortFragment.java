...
public class NotesListSortFragment extends DialogFragment {
	...
	public interface NotesListSortDialogListener {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		mListener = (NotesListSortDialogListener) getTargetFragment();
		AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
		LayoutInflater inflater = getActivity().getLayoutInflater();
		View view = inflater.inflate(R.layout.fragment_notes_list_sort, null);
		ButterKnife.bind(this, view);
		builder.setTitle(R.string.notes_list_sort_title);
