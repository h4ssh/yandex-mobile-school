...
public class ColorsListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ru.yandex.mobile_school.ColorsListAdapter.ViewHolder viewHolder;
		...
		if (convertView == null){
			...
			viewHolder = new ru.yandex.mobile_school.ColorsListAdapter.ViewHolder();
			ButterKnife.bind(viewHolder, convertView);
			convertView.setTag(viewHolder);
		} else {
			viewHolder = (ru.yandex.mobile_school.ColorsListAdapter.ViewHolder) convertView.getTag();
		}
